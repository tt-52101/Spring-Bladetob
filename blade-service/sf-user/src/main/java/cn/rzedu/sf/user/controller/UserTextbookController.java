...
import cn.rzedu.sf.user.service.IUserTextbookBizService;
...
public class UserTextbookController extends BladeController {
    ...
    private IUserTextbookBizService userTextbookBizService;

    /**
     * 设置在学课程
     */
    @PostMapping("/learning/setup")
    @ApiOperationSupport(order = 1)
    @ApiOperation(value = "设置在学课程", notes = "设置在学课程")
    public R<Boolean> setupLearningTextbook(
        ...
        boolean status = userTextbookBizService.setupLearningTextbook(userId, textbookId, lessonId);
     ...
     * 最近学习的课程
     */
    @GetMapping("/learning/recently")
    @ApiOperationSupport(order = 2)
    @ApiOperation(value = "最近学习的课程", notes = "最近学习的课程")
    public R findRecentlyTextbook(@ApiParam(value = "用户id", required = true) @RequestParam Integer userId) {
        List list = userTextbookBizService.findRecentlyTextbook(userId);
        return R.data(list);
    }
     ...
     * 当前学习课程
     */
    @GetMapping("/learning/current")
    @ApiOperationSupport(order = 3)
    @ApiOperation(value = "当前学习课程", notes = "当前学习课程")
    public R getLearningLesson(@ApiParam(value = "用户id", required = true) @RequestParam Integer userId) {
        Map map = userTextbookBizService.getLearningLesson(userId);
        return R.data(map);
    }
