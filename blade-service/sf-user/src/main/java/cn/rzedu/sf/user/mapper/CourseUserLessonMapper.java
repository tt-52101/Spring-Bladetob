...
/**
 * 课程学习情况表，记录用户在教材里面的课程lesson的学习情况，每个学生学习一个课程产生一个记录 Mapper 接口
 *
 * @author Blade
 * @since 2020-09-08
 */
public interface CourseUserLessonMapper extends BaseMapper<CourseUserLesson> {
     ...
     * @return
     */
    List<CourseUserLessonVO> selectCourseUserLessonPage(IPage page, CourseUserLessonVO courseUserLesson);
     ...
     * @return
     */
    Integer getFinishedLessonCount(Integer userId, Integer courseId);
